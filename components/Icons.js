export const StatusIcon = () => {
    return (
        <svg viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M12 20.664a9.163 9.163 0 0 1-6.521-2.702.977.977 0 0 1 1.381-1.381 7.269 7.269 0 0 0 10.024.244.977.977 0 0 1 1.313 1.445A9.192 9.192 0 0 1 12 20.664zm7.965-6.112a.977.977 0 0 1-.944-1.229 7.26 7.26 0 0 0-4.8-8.804.977.977 0 0 1 .594-1.86 9.212 9.212 0 0 1 6.092 11.169.976.976 0 0 1-.942.724zm-16.025-.39a.977.977 0 0 1-.953-.769 9.21 9.21 0 0 1 6.626-10.86.975.975 0 1 1 .52 1.882l-.015.004a7.259 7.259 0 0 0-5.223 8.558.978.978 0 0 1-.955 1.185z"></path></svg>
    )
}
...
export const BackIcon = ({ color = "#000" }) => {
    return (
        <svg className="" viewBox="0 0 24 24" width="24" height="24"><path fill={color} d="M12 4l1.4 1.4L7.8 11H20v2H7.8l5.6 5.6L12 20l-8-8 8-8z"></path></svg>
    )
}
...
export const StarIcon = () => {
    return (
        <svg viewBox="0 0 16 15" height="20" preserveAspectRatio="xMidYMid meet"><path fill="currentColor" d="M8.3 10.2l-2.5 1.7c-.3.2-.8-.1-.7-.5L6 8.6c.1-.2 0-.4-.2-.5L3.5 6.3c-.4-.3-.2-.8.2-.8l3-.1c.2 0 .3-.1.4-.3l1-2.8c.1-.4.7-.4.8 0l1 2.8c.1.2.2.3.4.3l3 .1c.4 0 .6.5.3.8l-2.4 1.8c-.1.1-.2.3-.2.5l.9 2.9c.1.4-.3.7-.7.5l-2.5-1.7c-.1-.2-.3-.2-.4-.1z"></path></svg>
    )
}

export const NotificationIcon = () => {
    return (
        <svg viewBox="0 0 24 24" height="20" preserveAspectRatio="xMidYMid meet"><path fill="currentColor" d="M12 21.7c.9 0 1.7-.8 1.7-1.7h-3.4c0 .9.8 1.7 1.7 1.7zm5.6-5.2v-4.7c0-2.7-1.8-4.8-4.3-5.4v-.6c0-.7-.6-1.3-1.3-1.3s-1.3.6-1.3 1.3v.6c-2.5.6-4.3 2.7-4.3 5.4v4.7l-1.7 1.7v.9h14.6v-.9l-1.7-1.7z"></path></svg>
    )
}

export const DisappearIcon = () => {
    return (
        <svg height="16" viewBox="0 0 21 21" fill="none" preserveAspectRatio="xMidYMid meet"><path fillRule="evenodd" clipRule="evenodd" d="M10.5 17a6.5 6.5 0 1 0 0-13 6.5 6.5 0 0 0 0 13zm3.41-9.93a.502.502 0 0 0-.679-.029l-3.832 3.222a.502.502 0 0 0-.032.74l.692.691c.208.208.55.194.74-.032l3.222-3.832a.502.502 0 0 0-.03-.678l-.081-.082z" fill="currentcolor"></path><path fillRule="evenodd" clipRule="evenodd" d="M18.325 10.531a7.856 7.856 0 0 0-7.856-7.856 1 1 0 0 1 0-2c5.443 0 9.856 4.413 9.856 9.856 0 5.444-4.413 9.857-9.856 9.857-5.444 0-9.857-4.413-9.857-9.857a1 1 0 1 1 2 0 7.856 7.856 0 1 0 15.713 0z" fill="currentcolor"></path></svg>
    )
}

export const BlockIcon = ({ color }) => {
    return (
        <svg viewBox="0 0 24 24" width="24" height="24"><path fill={color} d="M12 2.8c-5.3 0-9.7 4.3-9.7 9.7s4.3 9.7 9.7 9.7 9.7-4.3 9.7-9.7-4.4-9.7-9.7-9.7zm-7.3 9.7c0-4 3.3-7.3 7.3-7.3 1.6 0 3.1.5 4.3 1.4L6.1 16.8c-.9-1.2-1.4-2.7-1.4-4.3zm7.3 7.3c-1.6 0-3-.5-4.2-1.4L17.9 8.3c.9 1.2 1.4 2.6 1.4 4.2 0 4-3.3 7.3-7.3 7.3z"></path></svg>
    )
}

export const ThumbDownIcon = ({ color }) => {
    return (
        <svg viewBox="0 0 24 24" width="24" height="24"><path fill={color} d="M14.091 4.2H6.318c-.691 0-1.295.432-1.555 1.036l-2.591 6.132c-.086.173-.172.346-.172.605V13.7c0 .95.777 1.727 1.727 1.727h5.441L8.305 19.4v.259c0 .345.173.691.345.95l.95.864 5.7-5.7c.345-.345.518-.777.518-1.209V5.927c0-.95-.777-1.727-1.727-1.727zm3.454 0v10.364H21V4.2h-3.455z" id="thumb-down"></path></svg>
    )
}

export const DeleteIcon = ({color}) => {
    return (
        <svg viewBox="0 0 24 24" width="24" height="24"><path fill={color} d="M6 18c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V6H6v12zM19 3h-3.5l-1-1h-5l-1 1H5v2h14V3z"></path></svg>
    )
}